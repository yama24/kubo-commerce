<div class="wrapper">
	<a href="<?= base_url(); ?>">
		<h2 class="brand-name"><?= $this->config->item('app_name'); ?></h2>
	</a>
	...
	<form action="<?= base_url(); ?>register" method="post">
		...
		<small class="text-muted">Saya telah membaca dan menyetujui <a href="<?= base_url(); ?>terms" target="_blank">Syarat dan Ketentuan</a> serta <a href="<?= base_url(); ?>privacy-policy" target="_blank">Kebijakan Privasi</a> <?= $this->config->item('app_name'); ?></small>
