		...
		<div class="main">
			...
			<div class="form">
				<form action="<?= base_url(); ?>subscribe-email" method="post">
					...
					<input type="text" placeholder="Masukan email kamu" autocomplete="off" name="email" /><button type="submit">Subscribe</button>
				</form>
			</div>
		</div>
	</div>
...
<script src="<?= base_url(); ?>assets/bootstrap-4.4.1-dist/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
