	...
	<div class="top">
		<div class="main-top">
			...
			<div class="ket">
				...
				<p class="subtitle">Terjual <?= str_replace(",", ".", number_format($product['transaction'])); ?> Produk &bull; <?= str_replace(",", ".", number_format($product['viewer'])); ?>x Dilihat</p>
				<hr>
				<table>
					...
					<tr>
						<td class="t">Berat</td>
						<td><?= str_replace(",", ".", number_format($product['weight'])); ?> gram</td>
					</tr>
					<tr>
						<td class="t">Stok</td>
						<td><?= str_replace(",", ".", number_format($product['stock'])); ?> produk</td>
					</tr>
					<tr>
						<?php if ($setting['promo'] == 1) { ?>
							<?php if ($product['promo_price'] == 0) { ?>
