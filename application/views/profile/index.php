		...
		<div class="row mt-3">
			<div class="col-md-12">
				<div class="card shadow-sm">
					<div class="card-body">
						Jika ada pertanyaan silakan mengubungi whatsapp <?= $this->config->item('whatsapp'); ?> atau <a href="https://wa.me/<?= $this->config->item('whatsappv2'); ?>" target="_blank">klik disini</a>
					</div>
				</div>
			</div>
		</div>
