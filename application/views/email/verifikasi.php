		...
		<tr>
			...
			<td class="container">
				<div class="content">
					...
					<span class="preheader">Verifikasi email sangat diperlukan.</span>
								...
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td>
											...
											<p>terima kasih telah mendaftar<br>Silakan verifikasi email dengan klik link dibawah ini:</p>
													...
													<tr>
														<td align="left">
															<table border="0" cellpadding="0" cellspacing="0">
																<tbody>
																	<tr>
																		<td> <a href="<?php echo base_url() . "auth/verification?email=" . $email . "&token=" . $token ?>" target="_blank"><b>Verifikasi Email</b></a> </td>
																	</tr>
																</tbody>
															</table>
														</td>
