...
class Profile extends CI_Controller {
    ...
    public function index(){
        $data['title'] = 'Profil - ' . $this->config->item('app_name');
        $data['css'] = 'profile';
    ...
    public function transaction(){
        $data['title'] = 'Transaksi - ' . $this->config->item('app_name');
        $data['css'] = 'profile';
    ...
    public function detail_order($id){
        ...
        $data['title'] = 'Detail Pesanan - ' . $this->config->item('app_name');
        $data['css'] = 'profile';
    ...
    public function histories(){
        $data['title'] = 'Riwayat Transaksi - ' . $this->config->item('app_name');
        $data['css'] = 'profile';
    ...
    public function change_password(){
	    ...
	    if($this->form_validation->run() == false){
            $data['title'] = 'Ganti Kata Sandi - ' . $this->config->item('app_name');
            $data['css'] = 'profile';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/navbar');
