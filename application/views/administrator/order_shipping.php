...
<head>
	...
	<title>Shipping Label <?= $invoice['name']; ?> - <?= $invoice['invoice_code'] ?></title>
...
<body id="page-top">
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-body">
				<h3 class="lead">Label Pengiriman - <?= $invoice['invoice_code']; ?></h3>
				<hr>
				<div class="row">
					<div class="col-md-3">
						<table class="table table-sm table-borderless">
							...
							<tr>
								<td><img src="<?= base_url();  ?>assets/images/logo/logo.png" style="height: 70px;" alt=""></td>
							</tr>
							<tr>
								<td><b><?= $this->config->item('app_name'); ?></b> - <?= $this->config->item('whatsapp'); ?></td>
							</tr>
						</table>
					</div>
					<div class="col-md-9">
						<table class="table table-sm table-borderless">
							...
							<tr>
								<td>Alamat</td>
								<td><?= $invoice['address']; ?> <?= $invoice['village']; ?> <?= $invoice['district']; ?> <?= $regency; ?> <?= $province; ?> <?= $invoice['zipcode']; ?></td>
							</tr>
						</table>
					</div>
				</div>
		...
		<div class="card shadow mb-5">
			<div class="card-body">
				<h3 class="lead">Tabel Data - <?= $invoice['invoice_code']; ?></h3>
				<hr>
